...
import YouCriteriaPage from "../page/youCriteriaPage/youCriteriaPage";
import EditYouCriteriaPage from "../page/EditYouCriteriaPage/EditYouCriteriaPage";
import ContentModerationPage from "../page/ContentModerationPage/ContentModerationPage";
import SubscribersPage from "../page/SubscribersPage/SubscribersPage";
import ContentModerationInfo from "../page/ContentModerationInfo/ContentModerationInfo";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      {
        path: "ContentModeration/:id",
        element: <ContentModerationInfo/>
      },
      {
        path: "youCriteria",
        element: <YouCriteriaPage />,
      },
      {
        path: "youCriteria/:id",
        element: <EditYouCriteriaPage />,
      },
      {
        path: "/users",
