...
const Notification = () => {
  ...
  return (
    <div className=" pt-5  pr-5  h-[91vh] w-full">
      <h1 className="text-2xl font-bold mb-4">{t('Notification')}</h1>

      <div className="space-y-4">
        {paginatedNotifications.map((item) => (
          <div key={item.id} className=" rounded-md p-4 flex items-center space-x-4 border border-[#E4AE3C]">
            <div className="text-[#E4AE3C] border border-[#E4AE3C] rounded-full p-2">
