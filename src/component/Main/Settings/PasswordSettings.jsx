    ...
    <div className="h-[718px] p-10 bg-white inline-flex justify-start items-start gap-2.5">
      <div className="w-[507px] inline-flex flex-col justify-start items-start gap-8">
        <div className="w-28 flex flex-col justify-start items-start gap-5">
          <div className="self-stretch justify-start text-neutral-400 text-base font-normal font-['Kantumruy_Pro']">
            Profile Picture
          </div>
          <img
        ...
        >
          <div className="text-center justify-start text-white text-base font-bold font-['Mulish']">
            Change Password
          </div>
        </div>
      </div>
