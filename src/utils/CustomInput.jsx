      ...
      <div className="relative ">
        ...
        {isPassword ? (
          <Input.Password
            ...
            className={`w-full px-4 py-2 text-[16px] text-gray-700 rounded-lg ${className}`}
          ...
          <Input
            ...
            className={`w-full px-4 py-2 text-[16px] text-gray-700 rounded-lg bg-white ${className} `}
